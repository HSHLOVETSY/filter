...
class extKalmanFilter(object):
    ...
    # get status, From gyro angular vel to Euler angle dot
    ...
    # get trigonometric of roll&pitch
...
def animate(i, ekf, period_ms):
    ...
    ax1.axis('equal')  # 方案1：删除adjustable参数
    ax1.grid()
